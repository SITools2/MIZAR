 ...
 */
define(["../jquery", "../gw/Numeric", "../uws/UWSManager", "../service/Samp", "../gui_core/ErrorDialog", "../Utils", "../underscore-min", "text!../templates/healpixCutService.html", "text!../templates/cutResultItem.html", "../jquery.ui"],
