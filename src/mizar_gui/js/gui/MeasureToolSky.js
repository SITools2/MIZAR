...
define(["../jquery", "underscore-min", "../gw/Layer/VectorLayer", "../gw/Renderer/Ray", "../gw/Utils/Numeric", "../gw/Renderer/FeatureStyle", "../gw/Renderer/glMatrix", "../jquery.ui"],
    function ($, _, VectorLayer, Ray, Numeric, FeatureStyle) {
        ...
        MeasureToolSky.prototype.computeIntersection = function (points) {
         ...
         */
        MeasureToolSky.prototype.computeMeasure = function () {
            var rc = this.renderContext;
            // Scale to [-1,1]
         ...
         */
        MeasureToolSky.prototype.updateMeasure = function () {
            this.clear();
         ...
         *    Clear measure
         */
        MeasureToolSky.prototype.clear = function () {
