...
define(['../jquery', '../underscore-min', "../gw/FeatureStyle", "./Histogram", "../uws/UWSManager", "../uws/AnimatedButton", "./ErrorDialog", "text!../../templates/dynamicImageView.html", /*"jquery.ui.selectmenu"*/ "../jquery.ui"],
