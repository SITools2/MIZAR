...
define(["../jquery", "../underscore-min"],
    function ($, _) {
         ...
         */
        AbstractService.prototype.initParameters = function () {
        };
         ...
         */
        AbstractService.prototype.getParameters = function () {
         ...
         */
        AbstractService.prototype.convertParameters = function () {
        };
         ...
         * Convert parameters to an intelligible way for the called service
         */
        AbstractService.prototype.convertParametersToHTML = function () {
        };
         ...
         *    Call service
         */
        AbstractService.prototype.callService = function (parameters, doneCallback, failCallback, alwaysCallback) {
            $.ajax({
                method: 'GET',
                url: this.serviceUrl,
                data: parameters
